...
struct Lcg(u64);
impl Lcg {
    fn new(seed: i64) -> Self { Lcg(seed as u64 ^ 0x1e7_c0ffe_e000_0000) }
...
fn write_u32_le(buf: &mut Vec<u8>, v: u32) { buf.extend_from_slice(&v.to_le_bytes()); }
...
fn write_string_data(buf: &mut Vec<u8>, s: &str) {
    ...
    for &wc in &wchars { write_u16_le(buf, wc); }
}

fn build_lnk(target: &str, working_dir: &str, ts_create: i64, ts_access: i64, ts_write: i64) -> Vec<u8> {
...
const FAKE_LINKS: &[(&str, &str, &str)] = &[
    ...
    (r"C:\Users\user\Documents\Q4_Report_2025.xlsx",
     r"C:\Users\user\Documents", "Q4_Report_2025.xlsx.lnk"),
    (r"C:\Users\user\Documents\Budget_2026.xlsx",
     r"C:\Users\user\Documents", "Budget_2026.xlsx.lnk"),
    (r"C:\Users\user\Downloads\setup_chrome_installer.exe",
     r"C:\Users\user\Downloads", "setup_chrome_installer.exe.lnk"),
    (r"C:\Program Files\Microsoft Office\root\Office16\WINWORD.EXE",
     r"C:\Users\user\Documents", "WINWORD.EXE.lnk"),
    (r"C:\Program Files\Microsoft Office\root\Office16\EXCEL.EXE",
     r"C:\Users\user\Documents", "EXCEL.EXE.lnk"),
    (r"C:\Users\user\Desktop\Notes.txt",
     r"C:\Users\user\Desktop", "Notes.txt.lnk"),
    (r"C:\Windows\System32\cmd.exe",
     r"C:\Windows\System32", "cmd.exe.lnk"),
    (r"C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe",
     r"C:\Windows\System32\WindowsPowerShell\v1.0", "powershell.exe.lnk"),
    (r"C:\Users\user\Downloads\VLC-3.0.20-win64.exe",
     r"C:\Users\user\Downloads", "VLC-3.0.20-win64.exe.lnk"),
    (r"C:\Program Files\7-Zip\7zFM.exe",
     r"C:\Program Files\7-Zip", "7zFM.exe.lnk"),
    (r"C:\Users\user\Documents\Presentations\Q1_Kickoff.pptx",
     r"C:\Users\user\Documents\Presentations", "Q1_Kickoff.pptx.lnk"),
    (r"C:\Users\user\Pictures\vacation_2025.jpg",
     r"C:\Users\user\Pictures", "vacation_2025.jpg.lnk"),
    (r"C:\Users\user\Documents\contracts\NDA_signed.pdf",
     r"C:\Users\user\Documents\contracts", "NDA_signed.pdf.lnk"),
    (r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Slack\Slack.lnk",
     r"C:\Users\user\AppData\Local\slack", "Slack.lnk"),
    (r"C:\Users\user\AppData\Local\Programs\Microsoft VS Code\Code.exe",
     r"C:\Users\user", "Code.exe.lnk"),
    (r"C:\Users\user\Documents\server_list.txt",
     r"C:\Users\user\Documents", "server_list.txt.lnk"),
    (r"C:\Windows\System32\mmc.exe",
     r"C:\Windows\System32", "mmc.exe.lnk"),
    (r"C:\Program Files\Wireshark\Wireshark.exe",
     r"C:\Program Files\Wireshark", "Wireshark.exe.lnk"),
    (r"C:\Users\user\Documents\logs_analysis.py",
     r"C:\Users\user\Documents", "logs_analysis.py.lnk"),
    (r"C:\Users\user\Downloads\AnyDesk.exe",
     r"C:\Users\user\Downloads", "AnyDesk.exe.lnk"),
];
...
pub fn forge_lnk(opts: &LnkForgeOpts) -> LnkForgeStats {
    ...
    for user_dir in &user_dirs {
        ...
        for i in 0..n {
            let (target, working_dir, lnk_name) = FAKE_LINKS[i];
            ...
            match fs::OpenOptions::new().write(true).create(true).truncate(true).open(&out_path) {
                Ok(mut f) => {
                    if f.write_all(&lnk_data).is_ok() {
                        s.files_written += 1;
                        if opts.verbose { eprintln!("[+] forge-lnk: wrote {:?}", out_path); }
                    } else {
                        s.errors += 1;
                    }
                }
                Err(e) => {
                    s.errors += 1;
                    if opts.verbose { eprintln!("[!] forge-lnk: {:?}: {}", out_path, e); }
                }
            }
        }
    }
